...
import com.maciejprogramuje.facebook.logintest.api.certificate.CertificateReadyEvent;
...
public class MainActivity extends AppCompatActivity {
    private final String token = "3S1761L1";
    public static final String SYMBOL = "lublin";
    private final String pin = "712697";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBaseUrl = "https://lekcjaplus.vulcan.net.pl";
    ...
    public void onCertificateReady(CertificateReadyEvent event) {
        ...
        statusTextView.setText(String.format("OK\n\n%s", event.getUzytkownikNazwa()));

        postForPupilsList();
    }

    private void postForPupilsList() {
        PupilsListManager pupilsListManager = new PupilsListManager(bus, app);
