...
import com.maciejprogramuje.facebook.logintest.screens.F1_Intro;
import com.maciejprogramuje.facebook.logintest.screens.F2_login;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*mCertyfikatKlucz = ("83468642E73D92AB9C172543346302D7C7A095DB");
        ...
        StaticUtils.changeFragment(this, F1_Intro.newInstance());

        if (mBaseUrl.isEmpty() || mPfx.isEmpty() || mCertyfikatKlucz.isEmpty()) {
            progressBar.setVisibility(View.GONE);
            StaticUtils.changeFragment(this, F2_login.newInstance());
        } else {
